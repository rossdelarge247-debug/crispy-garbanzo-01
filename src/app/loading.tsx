  ...
  return (
    <div className="animate-fade-in pt-4">
      ...
      <div className="mb-8 pb-4 border-b border-surface-border">
        <div className="h-12 w-80 bg-surface-raised rounded-2xl mb-2" />
        <div className="h-5 w-64 bg-surface-raised rounded-xl" />
      </div>

      {/* Skeleton stats strip */}
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
        {[0, 1, 2, 3].map((i) => (
          <div key={i} className="p-4 text-center rounded-2xl bg-surface-raised shadow-card">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-8">
        {[0, 1, 2].map((i) => (
          <div key={i} className="rounded-2xl shadow-card bg-surface-raised p-5 h-64">
